...
class UserRepositoryTest {
    ...
    void create_ValidUser_SavesUser() {
        User user = new User(null, "test@example.com", "Test User", "testuser",
    ...
    void findAll_ReturnsListOfUsers() {
        User user1 = new User(null, "user1@example.com", "User One", "userone",
                LocalDate.of(1990, 1, 1));
        User user2 = new User(null, "user2@example.com", "User Two", "usertwo",
